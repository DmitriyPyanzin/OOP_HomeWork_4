...
//        appleBox.add(new Orange("Апельсины", 3.0)); // запрещено!!!
...
//        orangeBox.add(new Apple("Яблоки", 1.0)); // запрещено!!!
...
//        goldenAppleBox.add(new Apple("Яблоки", 2.0)); // запрещено!
...
//        appleBox.moveTo(goldenAppleBox); // нельзя!
//        orangeBox.moveTo(appleBox); // нельзя
    }
}